document.addEventListener("DOMContentLoaded", function() {
    ...
    if (contactForm) {
        contactForm.addEventListener("submit", function(event) {
            // Formspree will handle the submission, no need for custom JS here
            // contactForm.submit(); // Formspree handles this automatically
            // You might want to add a success message after Formspree redirects or uses AJAX
            // For now, let Formspree handle the full redirect/submission process.
